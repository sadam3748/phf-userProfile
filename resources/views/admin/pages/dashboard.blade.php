        ...
        <div class="row">
            ...
            <div class="col s12">
                                ...
                                <div class="card recent-buyers-card animate fadeUp">
                                    <div class="card-content">
                                        ...
                                        <ul class="collection mb-0">
                                            <li class="collection-item avatar">
                                                <img src="{{asset('images/avatar-7.png')}}" alt="" class="circle" />
                ...
                <span class="avatar-status avatar-online avatar-50"><img
                        src="{{asset('images/avatar-7.png')}}" alt="avatar" />
                  <i></i>
                </span>
                ...
                <span class="avatar-status avatar-online avatar-50"><img
                  ...
                  <i></i>
                                                ...
                                                <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                                                    data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img
                        src="{{asset('images/avatar-70.png')}}" alt="avatar" />
                  <i></i>
                </span>
                                                    <div class="user-content">
                                                ...
                                                <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                                                    data-target="slide-out-chat">
                <span class="avatar-status avatar-off avatar-50"><img
                        src="{{asset('images/avatar-71.png')}}" alt="avatar" />
                  <i></i>
                </span>
                                                    <div class="user-content">
                                                ...
                                                <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                                                    data-target="slide-out-chat">
                <span class="avatar-status avatar-online avatar-50"><img
                        src="{{asset('images/avatar-72.png')}}" alt="avatar" />
                  <i></i>
                </span>
                                                    <div class="user-content">
          ...
          <span class="avatar-status avatar-online avatar-50"><img src="{{asset('images/avatar-7.png')}}"
                                                                   alt="avatar" />
          </span>
